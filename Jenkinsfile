node {   
   ...
   stage('Nexus push'){
      ...
      nexusArtifactUploader artifacts: [[artifactId: 'myapp', classifier: '', file: '', type: 'war']], credentialsId: 'admin123456', groupId: 'com.sh', nexusUrl: '173.255.116.180:8081/', nexusVersion: 'nexus3', protocol: 'http', repository: 'nexusartifactid', version: '1.0'
   }
